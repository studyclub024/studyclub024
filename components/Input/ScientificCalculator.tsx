...
const ScientificCalculator: React.FC<Props> = ({ value, onChange, onSolve, disabled, extraButtons, embedded = false }) => {
  ...
  return (
    <div className={`${embedded ? '' : 'bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl border theme-border theme-glow'} overflow-hidden transition-all duration-700`}>
      {/* 1. Display Area */}
      <div className={`${embedded ? 'p-4 md:p-6' : 'theme-bg-soft p-6 md:p-8'} border-b theme-border relative`}>
        {!embedded && (
