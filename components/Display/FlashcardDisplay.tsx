...
const FlashcardDisplay: React.FC<Props> = ({ data, onRegenerateWithTheme, onMastery, isRegenerating, canUseThemes, onOpenUpgrade, fullWidth }) => {
  ...
  return (
    <div className={`${fullWidth ? 'w-full' : 'max-w-3xl mx-auto'} pb-10`}>
